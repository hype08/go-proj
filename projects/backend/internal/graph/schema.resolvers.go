...
import (
	...
	"github.com/hype08/go-proj/internal/graph/generated"
...
func (r *mutationResolver) UpdateUser(ctx context.Context, id uuid.UUID, input models.UpdateUserInput) (*models.User, error) {
